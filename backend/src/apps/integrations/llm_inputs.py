    ...
    return [
        {
            ...
            "content": (
                ...
                "En particular, si el texto nuevo pide coordinar, agendar, programar o "
                "confirmar una llamada/reunión, o pregunta qué día, fecha u horario tiene "
                "disponible el equipo, devolvé HUMAN con intent MEETING_OR_DATE, "
                "human_reason=MEETING_OR_DATE y proposed_body=null. No respondas pidiendo "
                "la disponibilidad del cliente ni afirmes que podés ajustar la agenda del "
                "equipo. No confundas esto con una consulta informativa general sobre "
                "horario de atención, teléfono, envíos o retiros: esas consultas pueden "
                "ser REPLY sólo si hay un fact aprobado claramente pertinente. "
